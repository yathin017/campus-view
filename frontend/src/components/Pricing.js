    ...
    <div className="bg-[#E4F4FA] py-60">
      <div className=" container h-screen px-5  mx-auto">
        <div className="flex flex-wrap -m-4 justify-center">
          ...
          <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
            <div className="h-full p-6 rounded-lg border-2 border-[#1B5A7A] flex flex-col relative overflow-hidden">
              <span className="bg-[#1B5A7A] text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">
                POPULAR
              </span>
              <h2 className="text-sm tracking-widest title-font mb-1 font-medium">
                PREMIUM
