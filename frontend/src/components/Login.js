                ...
                <div className='w-3/5 p-5'>
                    <div className='py-4'>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <a href='#' className='border-2 bg-[#1B5A7A] border-[#1B5A7A] text-[#E1F3F9] rounded-full px-12 py-2 inline-block font-semibold hover:bg-[#E1F3F9] hover:text-[#1B5A7A]'>Login</a>
                        </div>
                    </div>
                </div>
